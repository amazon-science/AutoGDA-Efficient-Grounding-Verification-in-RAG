...
export PYTHONPATH="./src"; python3 src/cross_encoder_model/fine_tuning_crossencoder.py -d summedits-${groupname}/sync -t summedits-${groupname}/test --save_model_name summedits-${groupname}_sync -e 3
