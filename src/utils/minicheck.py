    ...
    def __init__(self, model_name, max_input_length, batch_size, cache_dir) -> None:
        ...
        if model_name == 'flan-t5-large':
            ...
            self.model = AutoModelForSequenceClassification.from_pretrained(
                ckpt, config=config, revision='main', token=None, ignore_mismatched_sizes=False, cache_dir=cache_dir,
                device_map="auto")
...
class MiniCheck:
    def __init__(self, model_name='Bespoke-MiniCheck-7B', max_input_length=None, batch_size=16, cache_dir=None,
                 tensor_parallel_size=1, max_tokens=1, enable_prefix_caching=False) -> None:
        ...
        if model_name in ['roberta-large', 'deberta-v3-large', 'flan-t5-large']:
            ...
            raise ValueError('Bespoke-MiniCheck-7B not supported here.')
